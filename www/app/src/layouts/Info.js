                                                ...
                                                <div key={ data.sha.substr(0, 7) } className="column is-4-desktop is-6-mobile">
                                                    <div className="tags">
                                                        <Tag move=
                                                            { data.sha.substr(0, 7) }
                                                        />
                                                        <small>{ data.commit.author.name }</small>
                                                        <small>{ data.commit.message }</small>
                                                        <small>{ data.commit.author.date }</small>
                                                        <a class="button is-info" onClick={(e) => handle_info(data.sha)}>Info</a>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
